...
class TopicRenderReferenceEncoderTests: XCTestCase {
    ...
    func testRenderNodeSkipsReferences() throws {
        ...
        node.references = [
            "reference1": TopicRenderReference(
                identifier: .init("reference1"),
                title: "myFunction",
                abstract: [],
                url: "/documentation/MyClass/myFunction",
                kind: .symbol,
                estimatedTime: nil
            )
        ]
    ...
    func testTopicReferenceEncoder() throws {
        ...
        let newReference = TopicRenderReference(
            identifier: .init("reference1"),
            title: "NEW TITLE",
            abstract: [],
            url: "/documentation/MyClass/myFunction",
