    ...
    func testDecodingLegacyFormat() throws {
        ...
        XCTAssertEqual(
            ...
            [
                ...
                .init(id: "peak-memory", displayName: "Peak memory footprint", value: .bytesInMemory(8_273_920)),
                .init(id: "test-extra-memory", displayName: "Test extra memory footprint", value: .bytesInMemory(1_234_567)),
                ...
                .init(id: "test-extra-output-size", displayName: "Test extra output size", value: .bytesOnDisk(12_345_678)),
                .init(id: "total-archive-output-size", displayName: "Total DocC archive size", value: .bytesOnDisk(1_231_030)),
