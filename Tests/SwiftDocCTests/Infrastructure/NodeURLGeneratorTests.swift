...
class NodeURLGeneratorTests: XCTestCase {
    ...
    func testSafeURLWithBaseURL() throws {
        ...
        let basicIdentifier = ResolvedTopicReference(
            bundleIdentifier: "com.example.testbundle",
        ...
        XCTAssertEqual(
            generator.urlForReference(basicIdentifier).absoluteString,
            "file:///path/to/bundle/_testbundle-ctlj/products/documentation.builtbundle/com.example.testbundle/data/folder/class/symbol"
        )
        ...
        XCTAssertEqual(
            generator.urlForReference(symbolIdentifier).absoluteString,
            "file:///path/to/bundle/_testbundle-ctlj/products/documentation.builtbundle/com.example.testbundle/data/folder/class/'.=="
        )
        ...
        XCTAssertEqual(
            generator.urlForReference(privateIdentifier).absoluteString,
            "file:///path/to/bundle/_testbundle-ctlj/products/documentation.builtbundle/com.example.testbundle/data/folder/class/_privateMethod"
        )
        XCTAssertEqual(
            generator.urlForReference(privateIdentifier, lowercased: true).absoluteString,
            "file:///path/to/bundle/_testbundle-ctlj/products/documentation.builtbundle/com.example.testbundle/data/folder/class/_privatemethod"
        )
        ...
        XCTAssertEqual(
            ...
            "file:///path/to/bundle/_testbundle-ctlj/products/documentation.builtbundle/com.example.testbundle/data/folder/_privateclass/_privatesubclass"
        )
    }
