...
class BundleDiscoveryTests: XCTestCase {
    ...
    func testFirstBundle() throws {
        ...
        for i in 1...3 {
            let nestedBundle = Folder(
                name: "TestBundle\(i).docc",
                content: [
    ...
    func testLoadComplexWorkspace() throws {
                    ...
                    content: [
                        ...
                        Folder(
                            ...
                            content: [
                                ...
                                Folder(
                                    name: "Subfolder",
                                    content:  // All files flattened into one folder
        ...
        let bundles = (try dataProvider.bundles())
            .sorted { (bundle1, bundle2) -> Bool in
        ...
        try checkExpectedFilesFoundIn(
            Folder(
                ...
                content: [
                    ...
                    Folder(name: "One", content: allFiles[..<10].map { CopyOfFile(original: $0) })
                        .appendingFile(
                            Folder(name: "Two", content: allFiles[10..<20].map { CopyOfFile(original: $0) })
                                .appendingFile(
                                    Folder(name: "Three", content: allFiles[20..<30].map { CopyOfFile(original: $0) })
                                        .appendingFile(
