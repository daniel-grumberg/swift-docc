...
class DocumentationContextTests: XCTestCase {
    ...
    func testLoadEntity() throws {
        ...
        XCTAssertThrowsError(
            try context.entity(with: ResolvedTopicReference(bundleIdentifier: "some.other.bundle", path: "/tutorials/Test-Bundle/TestTutorial", sourceLanguage: .swift))
        )

        XCTAssertThrowsError(
            try context.entity(with: ResolvedTopicReference(bundleIdentifier: "org.swift.docc.example", path: "/Test-Bundle/wrongIdentifier", sourceLanguage: .swift))
        )
    ...
    func testThrowsErrorForMissingResource() throws {
        ...
        let context = try DocumentationContext(dataProvider: workspace)
        XCTAssertThrowsError(
            try context.resource(with: ResourceReference(bundleIdentifier: "com.example.missing", path: "/missing.swift")),
                ...
                return [
                    Problem(
                        diagnostic: Diagnostic(
                            ...
                            range: nil,
                            identifier: "com.tests.testGraphChecks",
                            summary: "test error"
                        ),
                        possibleSolutions: []
                    )
    ...
    func testLoadsSymbolData() throws {
        ...
        XCTAssertNotNil(
            myClassSymbol.availability?.availability
                .first(where: { (availability) -> Bool in
    ...
    func testMergesMultipleSymbolDeclarations() throws {
        ...
        XCTAssertNotNil(
            myClassSymbol.declaration[[PlatformName(operatingSystemName: "ios"), PlatformName(operatingSystemName: "macos")]]
                ?? myClassSymbol.declaration[[PlatformName(operatingSystemName: "macos"), PlatformName(operatingSystemName: "ios")]]
        )
    }
    ...
    func testDetectsDuplicateSymbolArticles() throws {
        ...
        let testBundle = Folder(
            name: "TestDetectsDuplicateSymbolArticles.docc",
            content: [
        ...
        struct TestData {
            ...
            var symbolGraphFiles: [File] {
                return symbolGraphNames.map { name in
                    CopyOfFile(
                        original: Bundle.module.url(forResource: "TestBundle", withExtension: "docc", subdirectory: "Test Bundles")!
    ...
    func testCuratesSymbolsAndArticlesCorrectly() throws {
        ...
        XCTAssertEqual(
            context.finitePaths(to: ResolvedTopicReference(bundleIdentifier: "org.swift.docc.example", path: "/documentation/MyKit/MyClass", sourceLanguage: .swift))
        ...
        XCTAssertEqual(
            context.finitePaths(to: ResolvedTopicReference(bundleIdentifier: "org.swift.docc.example", path: "/documentation/MyKit/MyClass/init()-33vaw", sourceLanguage: .swift))
                .map { $0.map { $0.absoluteString } },
            [
    ...
    func createNode(in context: DocumentationContext, bundle: DocumentationBundle, parent: ResolvedTopicReference, name: String) throws -> (DocumentationNode, TopicGraph.Node) {
        ...
        let node = DocumentationNode(
            ...
            name: .conceptual(title: name),
            markup: Document(parsing: "# \(name)"),
            semantic: nil
        )
    ...
    func testRootSymbolsAreCuratedInModule() throws {
        ...
        XCTAssertNil(
            graph.relationships.first { (relationship) -> Bool in
    ...
    func testCurateTutorialMultipleTimes() throws {
        ...
        let (_, _, context) = try testBundleAndContext(copying: "TestBundle") { root in
            ...
            let text = try String(contentsOf: myKitURL)
        ...
        let paths = context.finitePaths(to: node.reference)
        ...
        XCTAssertEqual(
            paths,
            [
                ["/documentation/MyKit"], ["/documentation/MyKit", "/documentation/Test-Bundle/article"],
                ["/tutorials/TestOverview", "/tutorials/TestOverview/$volume", "/tutorials/TestOverview/Chapter-1"],
            ]
        )
    }
    ...
    func testNonOverloadPaths() throws {
        ...
        XCTAssertNoThrow(
            try context.entity(
                with: ResolvedTopicReference(bundleIdentifier: "org.swift.docc.example", path: "/documentation/SideKit/SideClass/test-swift.enum.case", sourceLanguage: .swift)
            )
        )
        XCTAssertNoThrow(
            try context.entity(
                with: ResolvedTopicReference(bundleIdentifier: "org.swift.docc.example", path: "/documentation/SideKit/SideClass/test-swift.var", sourceLanguage: .swift)
            )
        )
    }
    ...
    func testOverloadPlusNonOverloadCollisionPaths() throws {
        ...
        XCTAssertNoThrow(
            try context.entity(
                with: ResolvedTopicReference(bundleIdentifier: "org.swift.docc.example", path: "/documentation/SideKit/SideClass/Test-swift.enum", sourceLanguage: .swift)
            )
        )
        XCTAssertNoThrow(
            try context.entity(
                with: ResolvedTopicReference(bundleIdentifier: "org.swift.docc.example", path: "/documentation/SideKit/SideClass/tEst-9053a", sourceLanguage: .swift)
            )
        )
        XCTAssertNoThrow(
            try context.entity(
                with: ResolvedTopicReference(bundleIdentifier: "org.swift.docc.example", path: "/documentation/SideKit/SideClass/test-959hd", sourceLanguage: .swift)
            )
        )
    }
    ...
    func testUnknownSymbolKind() throws {
        ...
        let node = try context.entity(
            with: ResolvedTopicReference(bundleIdentifier: "org.swift.docc.example", path: "/documentation/MyKit/MyClass/myFunction()", sourceLanguage: .swift)
        )
    ...
    func testSpecialCharactersInLinks() throws {
        let originalSymbolGraph = Bundle.module.url(forResource: "TestBundle", withExtension: "docc", subdirectory: "Test Bundles")!
            .appendingPathComponent("mykit-iOS.symbols.json")
        ...
        XCTAssertEqual(
            (renderNode.references["doc://special-characters/documentation/special-characters/Article:-with---various!-whitespace-&-punctuation.-in,-filename"]
                as? TopicRenderReference)?
                .title,
            "Article with various whitespace and punctuation in its filename"
        )
        XCTAssertEqual(
            (renderNode.references["doc://special-characters/documentation/special-characters/Article:-with---various!-whitespace-&-punctuation.-in,-filename#Hello-world"]
                as? TopicRenderReference)?
                .title,
            "Hello world"
        )
    ...
    func testNonOverloadCollisionFromExtension() throws {
        ...
        XCTAssertNoThrow(
            try context.entity(
                with: ResolvedTopicReference(bundleIdentifier: "org.swift.docc.example", path: "/documentation/SideKit/SideClass-swift.class", sourceLanguage: .swift)
            )
        )
        XCTAssertNoThrow(
            try context.entity(
                with: ResolvedTopicReference(bundleIdentifier: "org.swift.docc.example", path: "/documentation/SideKit/SideClass-swift.class/path", sourceLanguage: .swift)
            )
        )
        XCTAssertNoThrow(
            try context.entity(with: ResolvedTopicReference(bundleIdentifier: "org.swift.docc.example", path: "/documentation/SideKit/sideClass-swift.var", sourceLanguage: .swift))
        )
    }
    ...
    func testUnresolvedSidecarDiagnostics() throws {
        ...
        XCTAssertEqual(
            ...
            SourceLocation(
                line: 1,
                column: 3,
                source: unmatchedSidecarProblem.diagnostic.source
            )..<SourceLocation(line: 1, column: 26, source: unmatchedSidecarProblem.diagnostic.source)
        )
    ...
    func testUpdatesReferencesForChildrenOfCollisions() throws {
        ...
        XCTAssertNoThrow(
            try context.entity(
                with: ResolvedTopicReference(bundleIdentifier: "org.swift.docc.example", path: "/documentation/SideKit/SideClass/Test-swift.enum/path", sourceLanguage: .swift)
            )
        )
        ...
        XCTAssertNoThrow(
            try context.entity(
                with: ResolvedTopicReference(
                    bundleIdentifier: "org.swift.docc.example",
                    path: "/documentation/SideKit/SideClass/Test-swift.enum/nestedEnum-swift.property",
                    sourceLanguage: .swift
                )
            )
        )
        ...
        XCTAssertNoThrow(
            try context.entity(
                with: ResolvedTopicReference(
                    bundleIdentifier: "org.swift.docc.example",
                    path: "/documentation/SideKit/SideClass/Test-swift.enum/NestedEnum-swift.enum/path",
                    sourceLanguage: .swift
                )
            )
        )
    ...
    func testCrossSymbolGraphPathCollisions() throws {
        ...
        let bundleURL = try Folder(
            ...
            content: [
                ...
                CopyOfFile(
                    original: Bundle.module.url(
                        forResource: "Collisions-iOS.symbols",
                        withExtension: "json",
                ...
                CopyOfFile(
                    original: Bundle.module.url(
                        forResource: "Collisions-macOS.symbols",
                        withExtension: "json",
                        subdirectory: "Test Resources"
                    )!
                ),
    ...
    func testAbstractAfterMetadataDirective() throws {
        ...
        let node = try context.entity(
            with: ResolvedTopicReference(bundleIdentifier: "org.swift.docc.example", path: "/documentation/SideKit/SideClass/init()", sourceLanguage: .swift)
        )
    ...
    func testLinkResolutionDoesNotSkipSymbolGraph() throws {
        ...
        let bundleURL = try Folder(
            ...
            content: [
                ...
                CopyOfFile(
                    original: Bundle.module.url(
                        forResource: "MissingDocs.symbols",
                        withExtension: "json",
                        subdirectory: "Test Resources"
                    )!
                ),
    ...
    func testCreatingAnArticleNode() throws {
        ...
        let semanticArticle = Article(
            title: Heading(level: 1, [Text("New Article")]),
            abstractSection: nil,
            discussion: nil,
            topics: nil,
            seeAlso: nil,
            ...
            originalLinkRangesByGroup: [
                [
                    SourceLocation(
                        line: 9,
                        column: 41,
                        source: URL(fileURLWithPath: "/howardst/747.md")
                    )..<SourceLocation(line: 9, column: 42, source: URL(fileURLWithPath: "/howardst/747.md"))
                ]
            ]
        )
    ...
    func testResolvingLinksToTopicSections() throws {
        ...
        XCTAssertEqual(
            ...
            [
                .reference(
                    identifier: RenderReferenceIdentifier("doc://unit-test/documentation/ModuleName#One"),
                    isActive: true,
                    overridingTitle: nil,
                    overridingTitleInlineContent: nil
                ),
                .reference(
                    identifier: RenderReferenceIdentifier("doc://unit-test/documentation/ModuleName#Two"),
                    isActive: true,
                    overridingTitle: nil,
                    overridingTitleInlineContent: nil
                ),
                .reference(
                    identifier: RenderReferenceIdentifier("doc://unit-test/documentation/unit-test/First#Topics"),
                    isActive: true,
                    overridingTitle: nil,
                    overridingTitleInlineContent: nil
                ),
                .reference(
                    identifier: RenderReferenceIdentifier("doc://unit-test/documentation/unit-test/Second#Some-topic-section"),
                    isActive: true,
                    overridingTitle: nil,
                    overridingTitleInlineContent: nil
                ),
                .reference(
                    identifier: RenderReferenceIdentifier("doc://unit-test/documentation/unit-test/Third#Another-topic-section"),
                    isActive: true,
                    overridingTitle: nil,
                    overridingTitleInlineContent: nil
                ),
    ...
    func testMatchesDocumentationExtensionsAsSymbolLinks() throws {
        ...
        do {
            ...
            let reference = ResolvedTopicReference(
                bundleIdentifier: bundle.identifier,
                path: "/documentation/MixedFramework/CollisionsWithDifferentCapitalization/someThing-90i4h",
                sourceLanguage: .swift
            )
        ...
        do {
            ...
            let reference = ResolvedTopicReference(
                bundleIdentifier: bundle.identifier,
                path: "/documentation/MixedFramework/CollisionsWithDifferentCapitalization/something-2c4k6",
                sourceLanguage: .swift
            )
        ...
        do {
            ...
            let reference = ResolvedTopicReference(
                bundleIdentifier: bundle.identifier,
                path: "/documentation/MixedFramework/CollisionsWithEscapedKeywords/subscript()-swift.method",
                sourceLanguage: .swift
            )
        ...
        do {
            ...
            let reference = ResolvedTopicReference(
                bundleIdentifier: bundle.identifier,
                path: "/documentation/MixedFramework/CollisionsWithEscapedKeywords/subscript()-swift.subscript",
                sourceLanguage: .swift
            )
        ...
        do {
            ...
            let reference = ResolvedTopicReference(
                bundleIdentifier: bundle.identifier,
                path: "/documentation/MixedFramework/CollisionsWithEscapedKeywords/subscript()-swift.type.method",
                sourceLanguage: .swift
            )
    ...
    func testMatchesDocumentationExtensionsWithSourceLanguageSpecificLinks() throws {
        ...
        do {
            ...
            let reference = ResolvedTopicReference(
                bundleIdentifier: bundle.identifier,
                path: "/documentation/MixedFramework/MyObjectiveCClassSwiftName/myMethod(argument:)",
                sourceLanguage: .swift
            )
        ...
        do {
            ...
            let reference = ResolvedTopicReference(
                bundleIdentifier: bundle.identifier,
                path: "/documentation/MixedFramework/MyObjectiveCClassSwiftName/myMethodSwiftName()",
                sourceLanguage: .swift
            )
    ...
    func testMultipleDocumentationExtensionMatchDiagnostic() throws {
        ...
        let enumCaseMultipleMatchProblem = try XCTUnwrap(
            multipleDocExtensionProblems.first(where: { $0.diagnostic.summary == "Multiple documentation extensions matched 'MixedFramework/MyObjectiveCOption/first'." })
        )
        XCTAssert(
            ["objc-case.md", "objc-case-swift-name.md"].contains(enumCaseMultipleMatchProblem.diagnostic.source?.lastPathComponent ?? ""),
        ...
        XCTAssert(
            ["objc-case.md", "objc-case-swift-name.md"].contains(enumCaseMultipleMatchProblem.diagnostic.notes.first?.source.lastPathComponent ?? ""),
        ...
        let methodMultipleMatchProblem = try XCTUnwrap(
            multipleDocExtensionProblems.first(where: {
                $0.diagnostic.summary == "Multiple documentation extensions matched 'MixedFramework/MyObjectiveCClassSwiftName/myMethod(argument:)'."
            })
        )
        XCTAssert(
            ["objc-method.md", "objc-method-swift-name.md"].contains(methodMultipleMatchProblem.diagnostic.source?.lastPathComponent ?? ""),
            "The warning should refer to one of the documentation extensions files"
        )
        XCTAssertEqual(methodMultipleMatchProblem.diagnostic.notes.count, 1)
        XCTAssert(
            ["objc-method.md", "objc-method-swift-name.md"].contains(methodMultipleMatchProblem.diagnostic.notes.first?.source.lastPathComponent ?? ""),
            "The note should refer to one of the documentation extension files"
        )
        XCTAssertNotEqual(
    ...
    func testResolvePrecedenceArticleOverTutorialOverSymbol() throws {
        ...
        do {
            ...
            // Article
            XCTAssertNotNil(
                context.documentationCache[ResolvedTopicReference(bundleIdentifier: bundle.identifier, path: "/documentation/Test-Bundle/Test", sourceLanguage: .swift)]
            )
            // Tutorial
        ...
        do {
            ...
            // Symbol
            XCTAssertNotNil(
                context.documentationCache[ResolvedTopicReference(bundleIdentifier: bundle.identifier, path: "/documentation/Minimal_docs/Test", sourceLanguage: .swift)]
            )
    ...
    func testWarningForUnresolvableLinksInInheritedDocs() throws {
        ...
        let bundleURL = try Folder(
            ...
            content: [
                ...
                CopyOfFile(
                    original: Bundle.module.url(
                        forResource: "InheritedDocs-RelativeLinks.symbols",
                        withExtension: "json",
                        subdirectory: "Test Resources"
                    )!
                ),
