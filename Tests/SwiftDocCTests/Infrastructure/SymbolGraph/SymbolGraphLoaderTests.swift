...
class SymbolGraphLoaderTests: XCTestCase {
    ...
    func testLoadingiOSAndCatalystGraphs() throws {
        func testBundleCopy(iOSSymbolGraphName: String, catalystSymbolGraphName: String) throws -> (URL, DocumentationBundle, DocumentationContext) {
            return try testBundleAndContext(
                copying: "TestBundle",
                configureBundle: { bundleURL in
                    ...
                    catalystSymbolGraph.symbols["s:5MyKit0A5ClassC"]!.mixins[SymbolGraph.Symbol.Availability.mixinKey]! = SymbolGraph.Symbol.Availability(availability: [
                        .init(
                            domain: SymbolGraph.Symbol.Availability.Domain(rawValue: "Mac Catalyst"),
                            introducedVersion: .init(major: 1, minor: 0, patch: 0),
                        ...
                        .init(
                            domain: SymbolGraph.Symbol.Availability.Domain(rawValue: "iOS"),
                            introducedVersion: .init(major: 7, minor: 0, patch: 0),
                            deprecatedVersion: nil,
                            obsoletedVersion: nil,
                            message: nil,
                            renamed: nil,
    ...
    func testLoadingModuleBystanderExtensions() throws {
        let (_, bundle, _) = try testBundleAndContext(copying: "TestBundle", externalResolvers: [:]) { url in
            let bystanderSymbolGraphURL = Bundle.module.url(
                forResource: "MyKit@Foundation@_MyKit_Foundation.symbols",
                withExtension: "json",
    ...
    func testLoadingAsyncSymbolsWithJustOneFile() throws {
        ...
        for (symbolGraphFileName, shouldContainAsyncVariant) in [
            ("WithCompletionHandler", false), ("WithAsyncKeyword", true), ("DuplicateSymbolAsyncVariants", false), ("DuplicateSymbolAsyncVariantsReverseOrder", false),
        ] {
        ...
        let testBundle = Folder(
            ...
            content: [
                ...
                Folder(
                    ...
                    content: [
                        TextFile(
                            name: "MyModule-tvos-objc.symbols.json",
                            utf8Content: makeSymbolGraphString(
                                moduleName: "MyModule",
                                symbols: """
                                      {
                                        "accessLevel" : "public",
                        ...
                        TextFile(
                            name: "MyModule-catalyst-objc.symbols.json",
                            utf8Content: makeSymbolGraphString(
                                moduleName: "MyModule",
                                symbols: """
                                      {
