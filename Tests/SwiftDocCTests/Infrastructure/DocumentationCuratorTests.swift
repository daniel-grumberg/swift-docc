...
class DocumentationCuratorTests: XCTestCase {
    ...
    func testCrawl() throws {
        ...
        let sortedPairs = Set(curatedRelationships)
    ...
    func testCrawlDiagnostics() throws {
        ...
        XCTAssertEqual(
            ...
            SourceLocation(
                line: 12,
                column: 4,
                source: moduleCurationProblem?.diagnostic.source
            )..<SourceLocation(line: 12, column: 13, source: moduleCurationProblem?.diagnostic.source)
        )
        XCTAssertEqual(
        ...
        XCTAssertEqual(
            moduleCurationProblem?.diagnostic.explanation,
            """
        ...
        XCTAssertEqual(
            ...
            SourceLocation(
                ...
                column: 4,
                source: moduleCurationProblem?.diagnostic.source
            )..<SourceLocation(line: 13, column: 20, source: moduleCurationProblem?.diagnostic.source)
        )
        XCTAssertEqual(
        ...
        XCTAssertEqual(
            cyclicReferenceProblem?.diagnostic.explanation,
            """
    ...
    func testCyclicCurationDiagnostic() throws {
        ...
        XCTAssertEqual(
            curationProblem.diagnostic.explanation,
            """
            Links in a "Topics section" are used to organize documentation into a hierarchy. The documentation hierarchy shouldn't contain cycles.
    ...
    func testMixedManualAndAutomaticCuration() throws {
        ...
        XCTAssertEqual(
            ...
            [
                [
                    "/documentation/TestBed", "/documentation/TestBed/TopClass", "/documentation/TestBed/TopClass/NestedEnum",
                    "/documentation/TestBed/TopClass/NestedEnum/SecondLevelNesting", "/documentation/TestBed/MyArticle",
                ]
            ]
        )
