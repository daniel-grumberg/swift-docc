...
class SymbolDisambiguationTests: XCTestCase {
    ...
    private func disambiguatedReferencesForSymbols(
        swift swiftSymbols: [TestSymbolData],
        objectiveC objectiveCSymbols: [TestSymbolData]
    ) throws -> [SymbolGraph.Symbol.Identifier: ResolvedTopicReference] {
