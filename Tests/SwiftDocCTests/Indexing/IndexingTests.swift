...
class IndexingTests: XCTestCase {
    ...
    func testTutorialSection() throws {
        ...
        let tutorialSectionsSection = TutorialSectionsRenderSection(sections: [
            .init(
                title: "Section 1",
                contentSection: [.contentAndMedia(content: contentSection)],
                stepsSection: [.paragraph(.init(inlineContent: [.text("This is a step.")]))],
                anchor: "section-1"
            ),
            .init(
                title: "Section 2",
    ...
    func testRenderInlineContentReference() {
        let reference = RenderInlineContent.reference(
            ...
            isActive: true,
            overridingTitle: "Hello, world!",
            overridingTitleInlineContent: [.text("Hello, world!")]
        )
    ...
    func testRenderBlockContentStep() {
        let step = RenderBlockContent.step(
            .init(
                content: [.paragraph(.init(inlineContent: [.text("Hello, world!")]))],
                caption: [.paragraph(.init(inlineContent: [.text("Step caption")]))],
                media: RenderReferenceIdentifier("Media"),
                code: RenderReferenceIdentifier("Code"),
                runtimePreview: RenderReferenceIdentifier("Preview")
            )
        )
