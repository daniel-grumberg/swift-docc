...
class LineHighlighterTests: XCTestCase {
    ...
    static func bundleFolder(
        overview: TextFile = defaultOverview,
        tutorial: TextFile,
        codeFiles: [TextFile]
    ) -> Folder {
        return Folder(
            name: "TestNoSteps.docc",
            content: [
    ...
    func highlights(tutorialFile: TextFile, codeFiles: [TextFile]) throws -> [LineHighlighter.Result] {
        ...
        let tutorialReference = ResolvedTopicReference(
            bundleIdentifier: bundle.identifier,
            path: "/tutorials/Line-Highlighter-Tests/Tutorial",
            fragment: nil,
