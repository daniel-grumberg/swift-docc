...
class DefaultAvailabilityTests: XCTestCase {
    ...
    func testBundleWithDefaultAvailability() throws {
        ...
        do {
            let identifier = ResolvedTopicReference(
                ...
                path: "/documentation/MyKit/MyClass/init()-3743d",
                fragment: nil,
    ...
    private func assertRenderedPlatforms(
    ...
    func testInitializeWithCorrectAvailability() throws {
        ...
        let defaultAvailability = try PropertyListDecoder()
            .decode(
