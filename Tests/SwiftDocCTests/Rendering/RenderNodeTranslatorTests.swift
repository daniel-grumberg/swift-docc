...
class RenderNodeTranslatorTests: XCTestCase {
    ...
    func testAutomaticOverviewAndDiscussionHeadings() throws {
        guard
            let myFunctionDiscussion = try findDiscussion(
        ...
        guard
            let myClassDiscussion = try findDiscussion(
    ...
    func testSectionAbstracts() throws {
        ...
        let renderReference = try XCTUnwrap(
            renderedNode.references["doc://org.swift.docc.example/tutorials/Test-Bundle/TestTutorial#Create-a-New-AR-Project-%F0%9F%92%BB"] as? TopicRenderReference
        )
    ...
    func testAutomaticImplementationsWithExtraDots() throws {
        let fancyProtocolSGFURL = Bundle.module.url(
            forResource: "FancyProtocol.symbols",
            withExtension: "json",
