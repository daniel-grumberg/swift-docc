...
public class ExternalLinkTitleTests: XCTestCase {
    ...
    func testPlainTextExternalLinkTitle() throws {
        ...
        XCTAssertEqual(
            firstParagraph.inlineContent[1],
            RenderInlineContent.reference(identifier: expectedReferenceIdentifier, isActive: true, overridingTitle: nil, overridingTitleInlineContent: nil)
        )
