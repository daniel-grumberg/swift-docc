...
class TermListTests: XCTestCase {
    ...
    func testLinksAndCodeVoiceAsTerms() throws {
        ...
        do {
            ...
            XCTAssertEqual(
                ...
                [
                    .reference(
                        identifier: RenderReferenceIdentifier("doc://unit-test/documentation/ModuleName/someFunction(_:)"),
                        isActive: true,
                        overridingTitle: nil,
        ...
        do {
            ...
            XCTAssertEqual(
                ...
                [
                    .reference(
                        identifier: RenderReferenceIdentifier("doc://unit-test/documentation/ModuleName"),
                        isActive: true,
                        overridingTitle: nil,
                        overridingTitleInlineContent: nil
                    )
        ...
        do {
            ...
            XCTAssertEqual(
                ...
                [
                    .reference(
                        identifier: RenderReferenceIdentifier("doc://com.external.testbundle/path/to/something"),
                        isActive: true,
                        overridingTitle: nil,
                        overridingTitleInlineContent: nil
                    )
    ...
    func testRenderingListWithAllTermListItems() throws {
        ...
        var renderContentCompiler = RenderContentCompiler(
            context: context,
            bundle: bundle,
            identifier: ResolvedTopicReference(bundleIdentifier: bundle.identifier, path: "/path", fragment: nil, sourceLanguage: .swift)
        )
