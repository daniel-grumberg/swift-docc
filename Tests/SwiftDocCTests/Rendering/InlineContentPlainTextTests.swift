...
public class InlineContentPlainTextTests: XCTestCase {
    ...
    func testPlainTextFromReference() {
        ...
        let firstReferenceContent: [RenderInlineContent] = [
            .reference(
                ...
                isActive: true,
                overridingTitle: testText,
                overridingTitleInlineContent: [.text(testText)]
            )
        ]
    ...
    func testPlainTextFromMixed() {
        ...
        let expectedBasicText =
            "This is code. This is emphasized. This is strong. This is text. This is a new term. This is an inline header. This is a subscript. This is a superscript."
        ...
        let expectedComplicatedText =
            "\(expectedBasicText) \(expectedBasicText) \(expectedBasicText) \(expectedBasicText) \(expectedBasicText) \(expectedBasicText) \(expectedBasicText) \(expectedBasicText)"
