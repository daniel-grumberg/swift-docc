...
class ConvertSubcommandTests: XCTestCase {
    ...
    func testAdditionalSymbolGraphFiles() throws {
        ...
        do {
            ...
            XCTAssertEqual(
                action.converter.bundleDiscoveryOptions.additionalSymbolGraphFiles.map { $0.lastPathComponent }.sorted(),
                [
        ...
        do {
            ...
            XCTAssertEqual(
                convertOptions.additionalSymbolGraphFiles,
                [
            ...
            let action = try ConvertAction(fromConvertCommand: convertOptions)
            XCTAssertEqual(
                action.converter.bundleDiscoveryOptions.additionalSymbolGraphFiles,
                [
                    URL(fileURLWithPath: "/path/to/first.symbols.json"),
                    URL(fileURLWithPath: "/path/to/second.symbols.json"),
                ]
