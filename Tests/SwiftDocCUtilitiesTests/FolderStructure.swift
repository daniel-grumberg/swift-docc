...
extension Folder: AssertableFile {
    func __assertExist(at location: URL, fileManager: FileManagerProtocol, file: StaticString = #file, line: UInt = #line) {
        ...
        XCTAssert(
            ...
            "Folder '\(name)' should exist at '\(location.path)'",
            file: (file),
            line: line
        )
        XCTAssert(
            isFolder.boolValue,
            "Folder '\(name)' should be a folder",
            file: (file),
            line: line
        )
...
extension InfoPlist: AssertableFile {
    func __assertExist(at location: URL, fileManager: FileManagerProtocol, file: StaticString, line: UInt) {
        XCTAssert(
            ...
            "File '\(name)' should exist at '\(location.path)'",
            file: (file),
            line: line
        )
        ...
        do {
            ...
            XCTAssert(
                displayName == content.displayName && identifier == content.identifier && versionString == content.versionString,
                "File '\(name)' should contain the correct information.",
                file: (file),
                line: line
            )
...
extension TextFile: AssertableFile {
    func __assertExist(at location: URL, fileManager: FileManagerProtocol, file: StaticString, line: UInt) {
        ...
        XCTAssertEqual(
            fileManager.contents(atPath: location.path).map({ String(data: $0, encoding: .utf8) }),
            utf8Content,
            "File '\(name)' should contain '\(utf8Content)'",
            file: (file),
            line: line
        )
    }
...
extension CopyOfFile: AssertableFile {
    func __assertExist(at location: URL, fileManager: FileManagerProtocol, file: StaticString, line: UInt) {
        ...
        XCTAssert(
            ...
            "File '\(name)' should contain the same content as '\(original.path)'",
            file: (file),
            line: line
        )
    }
