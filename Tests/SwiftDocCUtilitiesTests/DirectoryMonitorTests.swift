...
class DirectoryMonitorTests: XCTestCase {
    ...
    private func monitor(
        url rootURL: URL,
        forChangeAtURL expectedChangeOrigin: URL?,
        withDirectoryTreeReload isTreeReloadExpected: Bool,
        triggerBlock: () throws -> Void,
    ...
    func testMonitorUpdates() throws {
        ...
        try monitor(
            url: tempFolderURL,
            forChangeAtURL: updateURL.deletingLastPathComponent(),
            withDirectoryTreeReload: true,
            triggerBlock: {
        ...
        try monitor(
            url: tempFolderURL,
            forChangeAtURL: updateURL,
            withDirectoryTreeReload: false,
            triggerBlock: {
