...
extension DocumentationContext {
    ...
    @available(
        *,
        deprecated,
        renamed: "globalExternalSymbolResolver",
        message: "Use 'globalExternalSymbolResolver' instead. This deprecated API will be removed after 6.0 is released"
    )
    ...
    @available(
        *,
        deprecated,
        renamed: "externalDocumentationSources",
        message: "Use 'externalDocumentationSources' instead. This deprecated API will be removed after 6.0 is released"
    )
