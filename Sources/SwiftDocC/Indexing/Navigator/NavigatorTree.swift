...
public class NavigatorTree {
    ...
    @available(
        *,
        deprecated,
        renamed: "read(from:bundleIdentifier:timeout:delay:queue:presentationIdentifier:broadcast:)",
        message: "Use 'read(from:bundleIdentifier:timeout:delay:queue:presentationIdentifier:broadcast:)' instead. This deprecated API will be removed after 6.1 is released"
    )
    public func read(
        from url: URL,
        bundleIdentifier: String? = nil,
