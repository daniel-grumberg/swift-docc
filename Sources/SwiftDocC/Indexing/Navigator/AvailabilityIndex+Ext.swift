...
public struct Platform: Hashable, CustomStringConvertible, Codable, Equatable {
    ...
    public struct Name: Hashable, CustomStringConvertible, Codable, Equatable {
        ...
        public static let apple = Set([
            Platform.Name.xcode, Platform.Name.macOS, Platform.Name.iOS, Platform.Name.watchOS, Platform.Name.watchOS, Platform.Name.tvOS, Platform.Name.macCatalyst,
        ])
