...
extension DirectiveArgumentWrapped where Value: DirectiveArgumentValueConvertible {
    ...
    @available(
        *,
        unavailable,
        message:
            "Directive argument of non-optional types without default value need to be required. Use an optional type or provide a default value to make this argument non-required."
    )
