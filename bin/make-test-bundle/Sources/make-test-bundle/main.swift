...
enum MakeTestBundle {
    static func main(arguments: [String]) throws {
        ...
        // Read size argument.
        guard let factorIndex = arguments.firstIndex(of: "--sizeFactor"), factorIndex.advanced(by: 1) < arguments.endIndex,
            let factor = UInt(arguments[factorIndex.advanced(by: 1)]), factor > 1
        else {
